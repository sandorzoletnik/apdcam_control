...
class ApdcamGui(QtWidgets.QMainWindow):
    ...
    def updateCameraState(self):
        ...
        self.adcControl.updateCameraState()
        self.controlTiming.updateCameraState()
        self.cameraTimer.updateCameraState()

    def updateDaqState(self):
        self.measure.updateDaqState()
        
    # An infinite loop in the background repeating every 1 seconds to periodically check the
    ...
    def updateGuiLoop(self):
        while True:
            ...
            self.updateDaqStateSignal.emit()
    ...
    def __init__(self, parent=None):
        ...
        self.updateCameraStateFlag   = True

        self.updateCameraStateSignal.connect(self.updateCameraState)
        self.updateDaqStateSignal.connect(self.updateDaqState)
